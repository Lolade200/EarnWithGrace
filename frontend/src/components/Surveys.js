    ...
    setSurveys([
        ...
        questions: [
          {
            ...
            options: ["Android", "Apple iOS", "Other"]
          },
          {
            id: "q2",
      ...
      },
      {
        ...
        questions: [
          {
            id: "q1",
            text: "What is your primary streaming service?",
            options: [
              "Netflix",
              "YouTube Premium",
              "Amazon Prime",
...
return ( <div className="surveys-page-wrapper"> <Header />
  ...
  {showAuthModal && (
    ...
    >
      ...
      >
        <FontAwesomeIcon
          icon={faLock}
          className="auth-gate-icon"
        />

        <h2>Sign In Required</h2>

        <p>
          Please sign in or create an account to submit survey responses and claim your Grace Points.
        </p>
