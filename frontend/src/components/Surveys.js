            ...
            questions: [
              {
                ...
                options: ["Netflix", "YouTube Premium", "Amazon Prime", "Other"]
              }
            ]
          }
        ]);
        ...
        <div className="surveys-container">
          <div className="surveys-header">
            ...
            <p className="surveys-subtitle">
              Participate in global research panels. Express your opinions to
              earn Grace Points instantly.
            </p>
          </div>
      ...
      {showAuthModal && (
        ...
        >
          ...
          >
            ...
            <p>
              Please sign in or create an account to submit survey responses and
              claim your Grace Points.
            </p>
